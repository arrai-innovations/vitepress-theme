...
provide(
    ...
    computed(() => Boolean(slots["home-hero-image"])),
);

const { visible: hasBreadcrumb } = useBreadcrumbs();
</script>
...
@media (min-width: 960px) {
    .Layout.has-breadcrumb :deep(.VPContent) {
        padding-top: calc(var(--vp-nav-height) + var(--arrai-breadcrumb-height));
    }

    .Layout.has-breadcrumb :deep(.VPLocalNav) {
        top: calc(var(--vp-nav-height) + var(--arrai-breadcrumb-height));
    }
}
</style>
